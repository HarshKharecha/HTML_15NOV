...
function MovieSelection() {
    ...
    return (
        <div style={{ padding: '24px', border: '1px solid #e2e8f0', borderRadius: '12px', margin: '20px', backgroundColor: '#f8fafc', fontFamily: 'sans-serif' }}>
            <h3 style={{ color: '#0f172a', borderBottom: '2px solid #e2e8f0', paddingBottom: '12px', margin: '0 0 20px 0', fontSize: '1.5rem' }}>
                Task 13: Movie Selection
            </h3>
                        ...
                        <div key={movie.id} style={styles.card(isSelected)}>
                            <div>
                                ...
                                <div style={styles.metadataGroup}>
                                    <div><span style={styles.tag}>Genre:</span> {movie.genre}</div>
                                    <div><span style={styles.tag}>Rating:</span> <span style={styles.rating}>★</span> {movie.rating}</div>
                                    <div><span style={styles.tag}>Released:</span> {movie.release}</div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                >
                                    {isSelected ? 'Deselect Movie' : 'Select Movie'}
                                </button>

                                {isSelected && (
                                    <div style={styles.message}>
                                        Currently Selected Movie ID: <strong>{selectedMovieId}</strong>
                                    </div>
                                )}
                            </div>
                        </div>
