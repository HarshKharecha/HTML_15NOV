...
//   // Local state to check if THIS specific card is in edit mode
//   const [isInlineEditing, setIsInlineEditing] = useState(false);
  
//   // Local state to manage the inputs for this card while editing
//   const [localData, setLocalData] = useState({ ...student });

//   const styles = {
//     card: { backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '16px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '12px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.02)', borderTop: '5px solid #2563eb' },
...
//     cardInput: { width: '100%', padding: '6px 8px', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '0.85rem', boxSizing: 'border-box' },
...
//   const handleSave = () => {
//     if (!localData.name.trim() || !localData.email.trim() || !localData.course.trim()) {
//       alert('Name, Email, and Course fields cannot be empty!');
//       return;
//     }
//     // Pass the locally updated student object back up to StudentForm.jsx
//     onEdit(localData);
//     setIsInlineEditing(false);
//   };

//   const handleCancel = () => {
//     // Reset local data back to initial props and close edit mode
...
//         {localData.image && <img src={localData.image} alt={localData.name} style={styles.avatar} />}
//       </div>

//       {isInlineEditing ? (
//         // SHOW THIS VIEW WHEN "EDIT" IS CLICKED (INLINE INPUTS)
//         <div>
...
//             <input type="text" name="status" value={localData.status} onChange={handleInputChange} style={styles.cardInput} />
//           </div>
...
//         </div>
//       ) : (
//         // SHOW THIS VIEW NORMALLY (DISPLAY TEXT)
//         <div>
...
//           <p style={styles.infoText}><strong>Status:</strong> {student.status}</p>
...
function StudentCard({ student = {}, onEdit, onDelete, instituteName }) {
  const [isInlineEditing, setIsInlineEditing] = useState(false);
  const [localData, setLocalData] = useState({ ...student });
  ...
  const styles = {
    ...
    avatar: { width: '100%', height: '100%', objectFit: 'cover' },
    studentName: { fontSize: '1.2rem', fontWeight: '700', color: '#0f172a', textAlign: 'center', margin: '0 0 4px 0' },
    instituteBadge: { fontSize: '0.8rem', fontWeight: 'bold', color: '#2563eb', backgroundColor: '#eff6ff', padding: '4px 8px', borderRadius: '4px', textAlign: 'center', marginBottom: '4px' },
    statusBadge: {
      fontSize: '0.8rem',
      fontWeight: 'bold',
